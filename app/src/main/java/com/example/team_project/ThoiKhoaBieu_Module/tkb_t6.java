...
public class tkb_t6 extends Fragment {

    RecyclerView RecView_T6;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =LayoutInflater.from(getContext()).inflate(R.layout.fragment_tkb_t6,container,false);
        // View view =  inflater.inflate(R.layout.fragment_tkb_T6, container, false);
        RecView_T6 = view.findViewById(R.id.listviewTKB_T6);
        arrayTKB = new ArrayList<>();
        adapter = new TKBAdapter(arrayTKB);
        RecView_T6.setAdapter(adapter);
