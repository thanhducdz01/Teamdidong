...
public class tkb_t3 extends Fragment {

    RecyclerView RecView_T3;
    String urlGetData ="http://10.0.2.2Didong/ketnoi.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =LayoutInflater.from(getContext()).inflate(R.layout.fragment_tkb_t3,container,false);
        // View view =  inflater.inflate(R.layout.fragment_tkb_t3, container, false);
        RecView_T3 = view.findViewById(R.id.listviewTKB_T3);
        arrayTKB = new ArrayList<>();
        adapter = new TKBAdapter(arrayTKB);
        RecView_T3.setAdapter(adapter);
