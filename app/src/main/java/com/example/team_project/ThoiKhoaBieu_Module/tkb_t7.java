...
public class tkb_t7 extends Fragment {

    RecyclerView RecView_T7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =LayoutInflater.from(getContext()).inflate(R.layout.fragment_tkb_t7,container,false);
        // View view =  inflater.inflate(R.layout.fragment_tkb_T7, container, false);
        RecView_T7 = view.findViewById(R.id.listviewTKB_T7);
        arrayTKB = new ArrayList<>();
        adapter = new TKBAdapter(arrayTKB);
        RecView_T7.setAdapter(adapter);
