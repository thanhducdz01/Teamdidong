...
public class tkb_t5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =LayoutInflater.from(getContext()).inflate(R.layout.fragment_tkb_t5,container,false);
        // View view =  inflater.inflate(R.layout.fragment_tkb_T5, container, false);
        RecView_T5 = view.findViewById(R.id.listviewTKB_T5);
        arrayTKB = new ArrayList<>();
        adapter = new TKBAdapter(arrayTKB);
        RecView_T5.setAdapter(adapter);
